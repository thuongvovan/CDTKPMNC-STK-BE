INSERT INTO Add_Provinces (Id,Name,FullName,NameEN,FullNameEN) VALUES
	 ...
	 (N'06',N'Bắc Kạn',N'Tỉnh Bắc Kạn',N'Bac Kan',N'Bac Kan Province'),
	 (N'08',N'Tuyên Quang',N'Tỉnh Tuyên Quang',N'Tuyen Quang',N'Tuyen Quang Province'),
	 (N'10',N'Lào Cai',N'Tỉnh Lào Cai',N'Lao Cai',N'Lao Cai Province'),
	 (N'11',N'Điện Biên',N'Tỉnh Điện Biên',N'Dien Bien',N'Dien Bien Province'),
...
INSERT INTO Add_Provinces (Id,Name,FullName,NameEN,FullNameEN) VALUES
	 ...
	 (N'22',N'Quảng Ninh',N'Tỉnh Quảng Ninh',N'Quang Ninh',N'Quang Ninh Province'),
	 (N'24',N'Bắc Giang',N'Tỉnh Bắc Giang',N'Bac Giang',N'Bac Giang Province'),
	 (N'25',N'Phú Thọ',N'Tỉnh Phú Thọ',N'Phu Tho',N'Phu Tho Province'),
	 (N'26',N'Vĩnh Phúc',N'Tỉnh Vĩnh Phúc',N'Vinh Phuc',N'Vinh Phuc Province'),
...
INSERT INTO Add_Provinces (Id,Name,FullName,NameEN,FullNameEN) VALUES
	 ...
	 (N'36',N'Nam Định',N'Tỉnh Nam Định',N'Nam Dinh',N'Nam Dinh Province'),
	 (N'37',N'Ninh Bình',N'Tỉnh Ninh Bình',N'Ninh Binh',N'Ninh Binh Province'),
	 (N'38',N'Thanh Hóa',N'Tỉnh Thanh Hóa',N'Thanh Hoa',N'Thanh Hoa Province'),
	 (N'40',N'Nghệ An',N'Tỉnh Nghệ An',N'Nghe An',N'Nghe An Province'),
...
INSERT INTO Add_Provinces (Id,Name,FullName,NameEN,FullNameEN) VALUES
	 ...
	 (N'51',N'Quảng Ngãi',N'Tỉnh Quảng Ngãi',N'Quang Ngai',N'Quang Ngai Province'),
	 (N'52',N'Bình Định',N'Tỉnh Bình Định',N'Binh Dinh',N'Binh Dinh Province'),
	 (N'54',N'Phú Yên',N'Tỉnh Phú Yên',N'Phu Yen',N'Phu Yen Province'),
	 (N'56',N'Khánh Hòa',N'Tỉnh Khánh Hòa',N'Khanh Hoa',N'Khanh Hoa Province'),
...
INSERT INTO Add_Provinces (Id,Name,FullName,NameEN,FullNameEN) VALUES
	 ...
	 (N'68',N'Lâm Đồng',N'Tỉnh Lâm Đồng',N'Lam Dong',N'Lam Dong Province'),
	 (N'70',N'Bình Phước',N'Tỉnh Bình Phước',N'Binh Phuoc',N'Binh Phuoc Province'),
	 (N'72',N'Tây Ninh',N'Tỉnh Tây Ninh',N'Tay Ninh',N'Tay Ninh Province'),
	 ...
	 (N'79',N'Hồ Chí Minh',N'Thành phố Hồ Chí Minh',N'Ho Chi Minh',N'Ho Chi Minh City');
INSERT INTO Add_Provinces (Id,Name,FullName,NameEN,FullNameEN) VALUES
	 ...
	 (N'84',N'Trà Vinh',N'Tỉnh Trà Vinh',N'Tra Vinh',N'Tra Vinh Province'),
	 (N'86',N'Vĩnh Long',N'Tỉnh Vĩnh Long',N'Vinh Long',N'Vinh Long Province'),
	 (N'87',N'Đồng Tháp',N'Tỉnh Đồng Tháp',N'Dong Thap',N'Dong Thap Province'),
	 (N'89',N'An Giang',N'Tỉnh An Giang',N'An Giang',N'An Giang Province'),
